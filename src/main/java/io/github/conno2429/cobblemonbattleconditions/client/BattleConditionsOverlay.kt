...
import io.github.conno2429.cobblemonbattleconditions.battle.WeatherTracker
import io.github.conno2429.cobblemonbattleconditions.util.extensions.colorSort
import io.github.conno2429.cobblemonbattleconditions.util.extensions.toPossessive
import io.github.conno2429.cobblemonbattleconditions.util.extensions.withRgb
...
object BattleConditionsOverlay {
    ...
    private fun resolveSideTurns(sideData: BattleSideData): MutableComponent {
        ...
        return sideComponent.text().colorSort(sideData).bold()
    }
